 ...
 * holds the graph. **So is `map`**: the file a place page names is the one
 * the build drew beside it — see {@link module:engine/site-maps} — and a
 * page with no drawing names none.
 *
