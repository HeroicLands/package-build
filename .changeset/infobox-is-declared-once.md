...
- A gear item's price, weight and durability reach the panel whichever way the note states them.
...
- Rows are labelled for a reader rather than named after the field behind them, and a value the system would have assumed anyway is left off: the panel says what the note says, and nothing else.
